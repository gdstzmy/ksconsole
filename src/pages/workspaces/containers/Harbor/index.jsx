...
// devops模块，地址为http://127.0.0.1:8000/workspaces/test/devops
...
export default class Harbor extends React.Component {
  ...
  get tips() {
    return [
      {
        title: t('HARBOR_TIP_GITOPS_Q'),
        description: t('HARBOR_TIP_GITOPS_A'),
      },
      // {
  ...
  render() {
    ...
    return (
      <ListPage {...this.props} getData={this.getData} match={matchParams}>
        <Banner
          {...bannerProps}
          description={t('HARBOR_DESCRIPTION')}
          tips={this.tips}
        />
